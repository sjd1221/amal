...
const renderYesNo = function(data, cell, _dataIndex, _cellIndex) {
    if(cell.data == 'اورژانسی'){
        cell.className = 'orj';          
        return 'اورژانسی'
    }if(cell.data == 'پر خطر'){
        cell.className = 'por' ;
        return 'پر خطر'
    }if(cell.data == 'آسیب پذیر'){
        cell.className = 'asib' ;
        return 'آسیب پذیر'
    }if(cell.data == 'عفونی'){
        cell.className = 'ofoni' ;
        return 'عفونی'
    }if(cell.data == 'الکتیو'){
        cell.className = 'elective' ;
        return 'الکتیو'
    }
                    // cell.childNodes = [
                    //     {
...
// const radif = function(data, rows, _dataIndex, _cellIndex) {
//     var count = rows
//     return data
...
// }
// table
const dataTable = new simpleDatatables.DataTable('#sjd' , {
    data: myData,
    perPageSelect: [10,9,8],
...
// style
// modelName
document.querySelector('.model-name').innerHTML = 'اتاق عمل'
